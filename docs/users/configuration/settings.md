...
| `ui.inlineThinkingMode`                 | string           | Display model thinking inline in the chat transcript. `off` keeps streamed thinking in the live status only, which avoids repeated scrollback rows in narrow terminals. `full` restores inline thinking for verbose debugging.                                                                                                                                                                                                                                                                                                                     | `"off"`     |
