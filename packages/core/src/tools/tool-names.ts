...
export const ToolNames = {
  ...
  SHELL_SEND_INPUT: 'shell_send_input',
  SHELL_READ_OUTPUT: 'shell_read_output',
  SHELL_PROCESS_STATUS: 'shell_process_status',
...
export const ToolDisplayNames = {
  ...
  GLOB: 'Glob',
  SHELL: 'Shell',
  SHELL_SEND_INPUT: 'ShellSendInput',
  SHELL_READ_OUTPUT: 'ShellReadOutput',
  SHELL_PROCESS_STATUS: 'ShellProcessStatus',
