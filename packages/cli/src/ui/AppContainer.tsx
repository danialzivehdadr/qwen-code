...
export const AppContainer = (props: AppContainerProps) => {
  ...
  //
  // VP mode handles resize via ink's reflow + its own overflow clipping,
  // so the physical write is unnecessary there too — the remount-key
  // bump alone keeps the legacy <Static> branch consistent in case the
  // user toggles `useTerminalBuffer` off mid-session.
