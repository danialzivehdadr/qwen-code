...
export default {
  ...
  "What Helped Most (Qwen's Capabilities)":
    'Was am meisten geholfen hat (Qwens Fähigkeiten)',
  Outcomes: 'Ergebnisse',
  'Fully Achieved': 'Vollständig erreicht',
  'Mostly Achieved': 'Größtenteils erreicht',
  'Partially Achieved': 'Teilweise erreicht',
  'Not Achieved': 'Nicht erreicht',
  Unclear: 'Unklar',
  'Primary Friction Types': 'Primäre Reibungstypen',
  'Inferred Satisfaction (model-estimated)':
    'Abgeleitete Zufriedenheit (modellgeschätzt)',
  Happy: 'Zufrieden',
  Satisfied: 'Befriedigt',
  'Likely Satisfied': 'Wahrscheinlich zufrieden',
  Dissatisfied: 'Unzufrieden',
  Frustrated: 'Frustriert',
  'Misunderstood Request': 'Missverstandene Anfrage',
  'Wrong Approach': 'Falscher Ansatz',
  'Buggy Code': 'Fehlerhafter Code',
  'User Rejected Action': 'Vom Benutzer abgelehnte Aktion',
  'Excessive Changes': 'Übermäßige Änderungen',
  'Fast Accurate Search': 'Schnelle genaue Suche',
  'Correct Code Edits': 'Korrekte Code-Bearbeitungen',
  'Good Explanations': 'Gute Erklärungen',
  'Proactive Help': 'Proaktive Hilfe',
  'Multi File Changes': 'Mehrfachdatei-Änderungen',
  'Good Debugging': 'Gutes Debugging',
  ...
  'messages across {{sessions}} sessions':
    'Nachrichten über {{sessions}} Sitzungen',
};
