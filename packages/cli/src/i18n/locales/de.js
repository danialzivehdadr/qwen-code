...
export default {
  ...
  'Impressive Things You Did →': 'Beeindruckende Erfolge →',
  ...
  'Just copy this into Qwen Code to add it to your QWEN.md.':
    'Kopieren Sie dies einfach in Qwen Code, um es zu Ihrem QWEN.md hinzuzufügen.',
  ...
  'Just copy this into Qwen Code and it will set it up for you.':
    'Kopieren Sie dies einfach in Qwen Code und es wird alles für Sie einrichten.',
