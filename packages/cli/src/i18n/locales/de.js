...
export default {
  ...
  'Your personalized coding journey and patterns': 'Ihre personalisierte Coding-Reise und Muster',
  'messages across {{sessions}} sessions': 'Nachrichten in {{sessions}} Sitzungen',
  'At a Glance': 'Auf einen Blick',
  "What's working:": 'Was funktioniert:',
  "What's hindering you:": 'Was Sie behindert:',
  'Quick wins to try:': 'Schnelle Erfolge zu versuchen:',
  ...
  'Existing Qwen Code Features to Try': 'Vorhandene Qwen Code-Funktionen zum Ausprobieren',
  ...
  'What Helped Most (Qwen\'s Capabilities)': 'Was am meisten geholfen hat (Qwen-Fähigkeiten)',
  'Outcomes': 'Ergebnisse',
  'Primary Friction Types': 'Haupttypen von Reibungspunkten',
  'Inferred Satisfaction (model-estimated)': 'Abgeleitete Zufriedenheit (Modell geschätzt)',
  'Suggested QWEN.md Additions': 'Vorgeschlagene QWEN.md-Ergänzungen',
  'Just copy this into Qwen Code to add it to your QWEN.md.': 'Kopieren Sie dies einfach in Qwen Code, um es zu Ihrem QWEN.md hinzuzufügen.',
  'Copy All Checked': 'Alle ausgewählten kopieren',
  'Copied All!': 'Kopiert!',
  ...
  'No insight data available': 'Keine Einblickdaten verfügbar',
  'Generating insights in {{language}}...': 'Einblicke werden auf {{language}} generiert...',
  'Starting insight generation...': 'Einblickgenerierung wird gestartet...',
  'Insight report generated successfully!': 'Einblicksbericht erfolgreich generiert!',
  'Opening insights in your browser: {{path}}': 'Einblicke werden in Ihrem Browser geöffnet: {{path}}',
  'Insights generated at: {{path}}. Please open this file in your browser.': 'Einblicke wurden unter {{path}} generiert. Bitte öffnen Sie diese Datei in Ihrem Browser.',
  'Failed to generate insights: {{error}}': 'Einblicke konnten nicht generiert werden: {{error}}',
  'This may take a couple minutes. Sit tight!': 'Dies kann einige Minuten dauern. Bitte warten Sie!',
  'Generating personalized insights...': 'Personalisierte Einblicke werden generiert...',
};
