...
export default {
  ...
  'Just copy this into Qwen Code to add it to your QWEN.md.':
    'これを Qwen Code にコピーすると、QWEN.md に追加されます。',
  'Copy All Checked ({{count}})': '選択したものをすべてコピー ({{count}})',
  'Copied All!': 'すべてコピーしました！',
  'Just copy this into Qwen Code and it will set it up for you.':
    'これを Qwen Code にコピーすると、自動で設定されます。',
  ...
  Less: '少ない',
  More: '多い',
  'Active Hours': 'アクティブ時間帯',
  Morning: '朝',
  Afternoon: '昼',
  Evening: '夕方',
  Night: '夜',
  'Generated by Qwen Code': 'Qwen Code で生成',
  Sessions: 'セッション',
  Streak: '連続日数',
  'Best Streak': '最高連続',
};
