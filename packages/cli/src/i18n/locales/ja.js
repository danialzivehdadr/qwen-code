...
export default {
  ...
  'Your personalized coding journey and patterns': 'あなたのパーソナルなコーディングの旅とパターン',
  'messages across {{sessions}} sessions': '{{sessions}} セッション間のメッセージ',
  'At a Glance': '概要',
  "What's working:": '順調な点：',
  "What's hindering you:": '障害になっている点：",
  'Quick wins to try:': 'クイックウィンの試み：',
  'Ambitious workflows:': '高度なワークフロー：',
  'Impressive Things You Did': 'あなたの素晴らしい実績',
  'Where Things Go Wrong': '問題のある箇所',
  'Existing Qwen Code Features to Try': '試すべきQwen Code機能',
  'New Ways to Use Qwen Code': 'Qwen Codeの新しい使い方',
  'On the Horizon': '今後の展望',
  'What You Work On': '取り組んでいること',
  'How You Use Qwen Code': 'Qwen Codeの使用方法',
  'What You Wanted': '達成しようとしていたこと',
  'Top Tools Used': 'よく使うツール',
  'What Helped Most (Qwen\'s Capabilities)': '最も助けになった機能（Qwenの能力）',
  'Outcomes': '結果',
  'Primary Friction Types': '主な摩擦タイプ',
  'Inferred Satisfaction (model-estimated)': '推定満足度（モデル推計）',
  'Suggested QWEN.md Additions': 'QWEN.mdへの追加を提案',
  'Just copy this into Qwen Code to add it to your QWEN.md.': 'これをQwen CodeにコピーすればQWEN.mdに追加できます。',
  'Copy All Checked': '選択したものを全てコピー',
  'Copied All!': 'コピー完了！',
  'Why for you:': 'あなたにとってのメリット：',
  'Paste into Qwen Code:': 'Qwen Codeに貼り付け：',
  'Getting started:': '始め方：',
  'Key pattern:': '鍵となるパターン：',
  ...
  'Insight report generated successfully!': 'インサイトレポートの生成に成功しました！',
  'Opening insights in your browser: {{path}}': 'ブラウザでインサイトを開いています：{{path}}',
  'Insights generated at: {{path}}. Please open this file in your browser.': 'インサイトは{{path}}に生成されました。ブラウザで開いてください。',
  'Failed to generate insights: {{error}}': 'インサイトの生成に失敗しました：{{error}}',
  'This may take a couple minutes. Sit tight!': '数分かかる場合があります。お待ちください！',
  'Generating personalized insights...': 'パーソナライズされたインサイトを生成中...',
};
