...
export default {
  ...
  'Impressive Things You Did': '素晴らしい成果',
  'Where Things Go Wrong': '問題のある箇所',
  'Existing Qwen Code Features to Try': '試すべき Qwen Code の機能',
  ...
  Dissatisfied: '不満',
  Frustrated: '不満足',
  'Misunderstood Request': '誤解されたリクエスト',
  'Wrong Approach': '誤ったアプローチ',
  'Buggy Code': 'バグのあるコード',
  'User Rejected Action': 'ユーザーが拒否したアクション',
  'Excessive Changes': '過度な変更',
  'Fast Accurate Search': '高速で正確な検索',
  'Correct Code Edits': '正しいコード編集',
  'Good Explanations': '良い説明',
  'Proactive Help': '積極的なヘルプ',
  'Multi File Changes': '複数ファイルの変更',
  'Good Debugging': '良いデバッグ',
  'Suggested QWEN.md Additions': 'QWEN.md への追加提案',
  'Just copy this into Qwen Code to add it to your QWEN.md.':
    'Qwen Code にコピーするだけで QWEN.md に追加できます。',
  'Copy All Checked ({{count}})': 'チェックしたものをすべてコピー ({{count}})',
