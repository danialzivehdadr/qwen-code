...
export default {
  ...
  "What's hindering you:": '阻碍您的因素：',
  'Quick wins to try:': '快速尝试的改进：',
  'Ambitious workflows:': '未来工作流：',
  'Impressive Things You Did →': '查看您的亮点 →',
  'Where Things Go Wrong →': '查看问题所在 →',
  'Features to Try →': '查看推荐功能 →',
  'On the Horizon →': '查看未来趋势 →',
