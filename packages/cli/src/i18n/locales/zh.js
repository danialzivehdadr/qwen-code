...
export default {
  ...
  // Insight Report
  // ============================================================================
  'Qwen Code Insights': 'Qwen Code 使用洞察',
  'Your personalized coding journey and patterns': '您的个性化编程历程与模式',
  'messages across {{sessions}} sessions': '{{sessions}} 个会话中的消息',
  'At a Glance': '概览',
  "What's working:": '进展顺利：',
  "What's hindering you:": '阻碍进展：',
  'Quick wins to try:': '快速尝试：',
  'Ambitious workflows:': '进阶工作流：',
  'Impressive Things You Did': '您的出色表现',
  'Where Things Go Wrong': '问题所在',
  'Existing Qwen Code Features to Try': '值得一试的 Qwen Code 功能',
  'New Ways to Use Qwen Code': '使用 Qwen Code 的新方式',
  'On the Horizon': '未来可能',
  'What You Work On': '您的工作内容',
  'How You Use Qwen Code': '您如何使用 Qwen Code',
  'What You Wanted': '您的目标',
  'Top Tools Used': '常用工具',
  'What Helped Most (Qwen\'s Capabilities)': '最大帮助（Qwen 的能力）',
  'Outcomes': '结果',
  'Primary Friction Types': '主要摩擦类型',
  'Inferred Satisfaction (model-estimated)': '推断满意度（模型估计）',
  'Suggested QWEN.md Additions': '建议添加到 QWEN.md',
  'Just copy this into Qwen Code to add it to your QWEN.md.': '直接复制到 Qwen Code 即可添加到您的 QWEN.md。',
  'Copy All Checked': '复制全部选中',
  'Copied All!': '已复制！',
  'Why for you:': '对您的价值：',
  ...
  'Opening insights in your browser: {{path}}': '正在浏览器中打开洞察：{{path}}',
  'Insights generated at: {{path}}. Please open this file in your browser.': '洞察已生成于：{{path}}。请在浏览器中打开此文件。',
  'Failed to generate insights: {{error}}': '生成洞察失败：{{error}}',
  'This may take a couple minutes. Sit tight!': '这可能需要几分钟，请稍候！',
  'Generating personalized insights...': '正在生成个性化洞察...',
};
