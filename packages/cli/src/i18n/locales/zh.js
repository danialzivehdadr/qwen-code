...
export default {
  ...
  // TUI display optimization (PR feat/tui-display-optimization)
  'ui.transcript.header': '── 详情视图（已冻结） ──',
  'ui.transcript.footer': 'Esc / Ctrl+O 退出 · ↑↓ 滚动 · PgUp/PgDn 翻页',
  'ui.transcript.frozenAt': '冻结于 {{time}}',
  'ui.thinkingPulse': '思考中…',
  'ui.thinkingPulseHint': '按 Ctrl+O 查看明细',
  'ui.turnSummary.cancelled': '已取消',
  'ui.turnSummary.failed': '失败',
  'ui.subagent.singleAgent': '子代理',
  'ui.subagent.completedLine': '完成',
  'ui.subagent.failedLine': '失败',
  'ui.subagent.cancelledLine': '已取消',
  'ui.subagent.runningLine': '运行中',
  'ui.subagent.statsTools': '{{n}} 个工具',
  'ui.subagent.statsTokens': '{{k}} tokens',
  'ui.subagent.groupCompleted': '{{n}} 个子代理已完成',
  'ui.subagent.groupRunning': '{{n}} 个子代理运行中…',
  'ui.subagent.groupMixed': '{{n}} 个子代理（{{states}}）…',
  'ui.subagent.stateRunning': '{{n}} 运行中',
  'ui.subagent.stateCompleted': '{{n}} 已完成',
  'ui.subagent.stateFailed': '{{n}} 失败',
  'ui.subagent.stateCancelled': '{{n}} 已取消',
  'ui.verbose.description': '切换详细显示模式（显示思考过程与完整工具明细）。',
  'ui.verbose.enabled': '已开启详细显示。',
  'ui.verbose.disabled': '已关闭详细显示。',
  'ui.verbose.statusOn': '详细显示为开启状态。可使用 /verbose off 关闭。',
  'ui.verbose.statusOff': '详细显示为关闭状态。可使用 /verbose on 开启。',
  'ui.verbose.usage': '用法：/verbose [on|off|toggle]',
};
