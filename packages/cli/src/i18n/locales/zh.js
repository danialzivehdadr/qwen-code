...
export default {
  ...
  'Dark Theme': '深色主题',
  'At a Glance': '概览',
  "What's working:": '做得好的方面：',
  "What's hindering you:": '阻碍您的方面：',
  'Quick wins to try:': '可尝试的快速改进：',
  'Ambitious workflows:': '雄心勃勃的工作流：',
  'Impressive Things You Did →': '查看您的精彩表现 →',
  'Where Things Go Wrong →': '查看问题所在 →',
  'Features to Try →': '查看推荐功能 →',
  'On the Horizon →': '查看未来展望 →',
  'What You Work On': '您的工作内容',
  'How You Use Qwen Code': '您如何使用 Qwen Code',
  'Impressive Things You Did': '您的精彩表现',
  'Where Things Go Wrong': '问题所在',
  'Existing Qwen Code Features to Try': '可尝试的 Qwen Code 功能',
  ...
  'Top Tools Used': '常用工具',
  'Key pattern:': '关键模式：',
  "What Helped Most (Qwen's Capabilities)": '最有帮助的功能（Qwen 能力）',
  Outcomes: '结果',
  'Fully Achieved': '完全达成',
  ...
  Dissatisfied: '不满意',
  Frustrated: '沮丧',
  'Misunderstood Request': '误解请求',
  'Wrong Approach': '错误方法',
  'Buggy Code': '代码有缺陷',
  'User Rejected Action': '用户拒绝操作',
  'Excessive Changes': '变更过多',
  'Fast Accurate Search': '快速准确搜索',
  'Correct Code Edits': '正确的代码编辑',
  'Good Explanations': '良好的解释',
  'Proactive Help': '主动帮助',
  'Multi File Changes': '多文件变更',
  'Good Debugging': '良好的调试',
  'Suggested QWEN.md Additions': '建议添加到 QWEN.md',
  'Just copy this into Qwen Code to add it to your QWEN.md.':
    '复制此内容到 Qwen Code 即可添加到您的 QWEN.md。',
