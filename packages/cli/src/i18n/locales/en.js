...
export default {
  ...
  'ui.transcript.header': '── Transcript (frozen) ──',
  'ui.transcript.footer': 'Esc / Ctrl+O to exit · ↑↓ scroll · PgUp/PgDn page',
  'ui.transcript.frozenAt': 'Frozen at {{time}}',
  'ui.thinkingPulse': 'Thinking…',
  'ui.thinkingPulseHint': 'Ctrl+O for details',
  'ui.turnSummary.cancelled': 'cancelled',
  'ui.turnSummary.failed': 'failed',
  ...
  'ui.subagent.groupRunning': 'Running {{n}} Agents...',
  ...
  'ui.subagent.stateCancelled': '{{n}} cancelled',
  'ui.verbose.description':
    'Toggle verbose display (shows thoughts inline and full tool detail).',
  'ui.verbose.enabled': 'Verbose display enabled.',
  'ui.verbose.disabled': 'Verbose display disabled.',
  'ui.verbose.statusOn': 'Verbose display is ON. Use /verbose off to disable.',
  'ui.verbose.statusOff': 'Verbose display is OFF. Use /verbose on to enable.',
  'ui.verbose.usage': 'Usage: /verbose [on|off|toggle]',
};
