...
export default {
  ...
  Happy: 'Happy',
  Satisfied: 'Satisfied',
  'Likely Satisfied': 'Likely Satisfied',
  Dissatisfied: 'Dissatisfied',
  Frustrated: 'Frustrated',
  'Misunderstood Request': 'Misunderstood Request',
  'Wrong Approach': 'Wrong Approach',
  'Buggy Code': 'Buggy Code',
  'User Rejected Action': 'User Rejected Action',
  'Excessive Changes': 'Excessive Changes',
  'Fast Accurate Search': 'Fast Accurate Search',
  'Correct Code Edits': 'Correct Code Edits',
  'Good Explanations': 'Good Explanations',
  'Proactive Help': 'Proactive Help',
  'Multi File Changes': 'Multi File Changes',
  'Good Debugging': 'Good Debugging',
