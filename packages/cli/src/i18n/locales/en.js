...
export default {
  ...
  'Your personalized coding journey and patterns': 'Your personalized coding journey and patterns',
  'messages across {{sessions}} sessions': 'messages across {{sessions}} sessions',
  ...
  'What Helped Most (Qwen\'s Capabilities)': 'What Helped Most (Qwen\'s Capabilities)',
  'Outcomes': 'Outcomes',
  'Primary Friction Types': 'Primary Friction Types',
  'Inferred Satisfaction (model-estimated)': 'Inferred Satisfaction (model-estimated)',
  'Suggested QWEN.md Additions': 'Suggested QWEN.md Additions',
  'Just copy this into Qwen Code to add it to your QWEN.md.': 'Just copy this into Qwen Code to add it to your QWEN.md.',
  ...
  'Generating insights in {{language}}...': 'Generating insights in {{language}}...',
  'Starting insight generation...': 'Starting insight generation...',
  'Insight report generated successfully!': 'Insight report generated successfully!',
  'Opening insights in your browser: {{path}}': 'Opening insights in your browser: {{path}}',
  'Insights generated at: {{path}}. Please open this file in your browser.': 'Insights generated at: {{path}}. Please open this file in your browser.',
  'Failed to generate insights: {{error}}': 'Failed to generate insights: {{error}}',
  'This may take a couple minutes. Sit tight!': 'This may take a couple minutes. Sit tight!',
  'Generating personalized insights...': 'Generating personalized insights...',
};
