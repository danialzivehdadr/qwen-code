...
export default {
  ...
  "What's hindering you:": 'Что вам мешает:',
  ...
  Outcomes: 'Результаты',
  'Fully Achieved': 'Полностью достигнуто',
  'Mostly Achieved': 'В основном достигнуто',
  'Partially Achieved': 'Частично достигнуто',
  ...
  'Likely Satisfied': 'Вероятно доволен',
  Dissatisfied: 'Неудовлетворён',
  Frustrated: 'Разочарован',
  'Misunderstood Request': 'Неправильно понятый запрос',
  'Wrong Approach': 'Неправильный подход',
  'Buggy Code': 'Код с ошибками',
  'User Rejected Action': 'Действие отклонено пользователем',
  'Excessive Changes': 'Чрезмерные изменения',
  'Fast Accurate Search': 'Быстрый точный поиск',
  'Correct Code Edits': 'Правильное редактирование кода',
  'Good Explanations': 'Хорошие объяснения',
  'Proactive Help': 'Проактивная помощь',
  'Multi File Changes': 'Изменения в нескольких файлах',
  'Good Debugging': 'Хороший отладка',
