...
export default {
  ...
  'Your personalized coding journey and patterns': 'Ваше персональное путешествие в программировании и паттерны',
  'messages across {{sessions}} sessions': 'сообщений в {{sessions}} сессиях',
  'At a Glance': 'Обзор',
  ...
  'Impressive Things You Did': 'Впечатляющие достижения',
  'Where Things Go Wrong': 'Проблемные места',
  'Existing Qwen Code Features to Try': 'Функции Qwen Code для пробы',
  'New Ways to Use Qwen Code': 'Новые способы использования Qwen Code',
  'On the Horizon': 'Перспективы',
  'What You Work On': 'Над чем вы работаете',
  'How You Use Qwen Code': 'Как вы используете Qwen Code',
  'What You Wanted': 'Чего вы хотели',
  'Top Tools Used': 'Часто используемые инструменты',
  'What Helped Most (Qwen\'s Capabilities)': 'Что больше всего помогло (возможности Qwen)',
  'Outcomes': 'Результаты',
  'Primary Friction Types': 'Основные типы проблем',
  'Inferred Satisfaction (model-estimated)': 'Предполагаемая удовлетворённость (оценка модели)',
  'Suggested QWEN.md Additions': 'Предложения для QWEN.md',
  'Just copy this into Qwen Code to add it to your QWEN.md.': 'Просто скопируйте это в Qwen Code, чтобы добавить в ваш QWEN.md.',
  'Copy All Checked': 'Копировать все выделенные',
  'Copied All!': 'Скопировано!',
  ...
  'No insight data available': 'Нет данных для аналитики',
  'Generating insights in {{language}}...': 'Генерация аналитики на {{language}}...',
  'Starting insight generation...': 'Начало генерации аналитики...',
  'Insight report generated successfully!': 'Отчёт аналитики успешно создан!',
  'Opening insights in your browser: {{path}}': 'Открытие аналитики в браузере: {{path}}',
  'Insights generated at: {{path}}. Please open this file in your browser.': 'Аналитика создана: {{path}}. Пожалуйста, откройте этот файл в браузере.',
  'Failed to generate insights: {{error}}': 'Не удалось создать аналитику: {{error}}',
  'This may take a couple minutes. Sit tight!': 'Это может занять несколько минут. Пожалуйста, подождите!',
  'Generating personalized insights...': 'Генерация персональной аналитики...',
};
