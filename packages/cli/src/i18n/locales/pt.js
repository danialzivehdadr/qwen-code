...
export default {
  ...
  "What Helped Most (Qwen's Capabilities)":
    'O Que Mais Ajudou (Capacidades do Qwen)',
  Outcomes: 'Resultados',
  'Fully Achieved': 'Totalmente Alcançado',
  'Mostly Achieved': 'Principalmente Alcançado',
  'Partially Achieved': 'Parcialmente Alcançado',
  'Not Achieved': 'Não Alcançado',
  Unclear: 'Não Claro',
  'Primary Friction Types': 'Tipos Primários de Fricção',
  'Inferred Satisfaction (model-estimated)':
    'Satisfação Inferida (estimada pelo modelo)',
  Happy: 'Feliz',
  Satisfied: 'Satisfeito',
  'Likely Satisfied': 'Provavelmente Satisfeito',
  Dissatisfied: 'Insatisfeito',
  Frustrated: 'Frustrado',
  'Misunderstood Request': 'Pedido Mal Entendido',
  'Wrong Approach': 'Abordagem Errada',
  'Buggy Code': 'Código com Bugs',
  'User Rejected Action': 'Ação Rejeitada pelo Usuário',
  'Excessive Changes': 'Mudanças Excessivas',
  'Fast Accurate Search': 'Busca Rápida e Precisa',
  'Correct Code Edits': 'Edições de Código Corretas',
  'Good Explanations': 'Boas Explicações',
  'Proactive Help': 'Ajuda Proativa',
  'Multi File Changes': 'Mudanças em Múltiplos Arquivos',
  'Good Debugging': 'Bom Debugging',
