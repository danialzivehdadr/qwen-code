...
export default {
  ...
  "What's hindering you:": 'O que está impedindo você:',
  'Quick wins to try:': 'Melhorias rápidas para tentar:',
  'Ambitious workflows:': 'Fluxos de trabalho ambiciosos:',
  'Impressive Things You Did →': 'Conquistas Impressionantes →',
  ...
  'Just copy this into Qwen Code and it will set it up for you.':
    'Basta copiar isso no Qwen Code e ele configurará tudo para você.',
  ...
  Evening: 'Noite',
  Night: 'Madrugada',
  'Generated by Qwen Code': 'Gerado pelo Qwen Code',
  Sessions: 'Sessões',
  Streak: 'Sequência',
