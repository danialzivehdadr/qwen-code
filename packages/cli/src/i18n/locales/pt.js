...
export default {
  ...
  'Your personalized coding journey and patterns': 'Sua jornada personalizada de programação e padrões',
  'messages across {{sessions}} sessions': 'mensagens em {{sessions}} sessões',
  'At a Glance': 'Visão Geral',
  "What's working:": 'O que está funcionando:',
  "What's hindering you:": 'O que está te阻碍ando:',
  'Quick wins to try:': 'Quick wins para experimentar:',
  'Ambitious workflows:': 'Workflows ambiciosos:',
  'Impressive Things You Did': 'Coisas Impressionantes Que Você Fez',
  'Where Things Go Wrong': 'Onde As Coisas Dão Errado',
  'Existing Qwen Code Features to Try': 'Recursos Existentes do Qwen Code Para Experimentar',
  ...
  'What Helped Most (Qwen\'s Capabilities)': 'O Que Mais Ajudou (Capacidades do Qwen)',
  'Outcomes': 'Resultados',
  'Primary Friction Types': 'Tipos de Atrito Primários',
  'Inferred Satisfaction (model-estimated)': 'Satisfação Inferida (estimada pelo modelo)',
  'Suggested QWEN.md Additions': 'Adições Sugeridas ao QWEN.md',
  'Just copy this into Qwen Code to add it to your QWEN.md.': 'Basta copiar isso para o Qwen Code para adicioná-lo ao seu QWEN.md.',
  'Copy All Checked': 'Copiar Todos Selecionados',
  'Copied All!': 'Copiado!',
  ...
  'Generating insights in {{language}}...': 'Gerando insights em {{language}}...',
  'Starting insight generation...': 'Iniciando geração de insights...',
  'Insight report generated successfully!': 'Relatório de insights gerado com sucesso!',
  'Opening insights in your browser: {{path}}': 'Abrindo insights no seu navegador: {{path}}',
  'Insights generated at: {{path}}. Please open this file in your browser.': 'Insights gerados em: {{path}}. Por favor, abra este arquivo no seu navegador.',
  'Failed to generate insights: {{error}}': 'Falha ao gerar insights: {{error}}',
  'This may take a couple minutes. Sit tight!': 'Isso pode levar alguns minutos. Aguarde!',
  'Generating personalized insights...': 'Gerando insights personalizados...',
};
